...
export {wrapper as GoogleApiWrapper} from 'google-maps-react';
export {Marker} from 'google-maps-react';
export {InfoWindow} from 'google-maps-react';
export {HeatMap} from 'google-maps-react';
export {Polygon} from 'google-maps-react';
export {Polyline} from 'google-maps-react';
export {Circle} from 'google-maps-react';
